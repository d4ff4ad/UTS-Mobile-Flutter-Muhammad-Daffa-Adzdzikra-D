...
class HomePage extends StatelessWidget {
  ...
  Widget _buildServicesGrid(BuildContext context) {
    final services = [
      ...
      {'title': 'Postingan', 'icon': Icons.article_outlined, 'color': const Color(0xFF00AA13), 'bg': const Color(0xFFE5F6EB)}, // Tambah Postingan Baru
    ...
    return Wrap(
      ...
      children: services.map((s) {
        return GestureDetector(
          onTap: () {
            if (s['title'] == 'Postingan') {
              Navigator.pushNamed(context, '/postingan');
            } else {
                ...
                SnackBar(
                  content: Row(
                    children: [
                      ...
                      Text('Layanan ${s['title']} belum tersedia'),
                    ],
                  ),
